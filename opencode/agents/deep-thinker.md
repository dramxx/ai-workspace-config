...
- Architecture and abstraction trade-offs (e.g., code-architecture-wrong-abstraction)
- Structure and boundary questions (e.g., project-structure)
- Naming and clarity decisions (e.g., naming-cheatsheet)
