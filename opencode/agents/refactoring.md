...
- If target files or modules are not clear, ask for the smallest scope that would let you proceed safely.
...
- If no clear target is provided, ask for scope before editing
