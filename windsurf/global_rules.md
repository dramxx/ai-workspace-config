...
- Then follow this global `global_rules.md`
...
- State assumptions to user clearly when context is incomplete
...
- For planning tasks, provide a well thought thru, detailed plan with concrete actions in phases
